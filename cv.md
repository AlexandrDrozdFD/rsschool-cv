...
Description: JavaScript (advanced): OOP, Git, GitKraken, DOM, JSON, AJAX, ES6, SPA, Node, WebPack, animation. 
...
__Description:__ to-do list application that allows you to manage and control cases and tasks
